...
Tabela BK_LOG została utworzona i poprawnie rejestruje wykonane backupy. Przygotowano procedurę bk_db, która realizuje kopie zapasowe zgodnie z właściwą nomenklaturą, a także procedurę bk_all_db odpowiedzialną za wykonywanie backupów sześciu baz danych. Dodatkowo procedura bk_growth porównuje statystyki i automatycznie wykonuje kopię w przypadku wykrycia wzrostu.
