...
-- Procedura odtwarzajaca klucze obce
...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT 'Found store_id=' + CAST(@store_id AS varchar(10)) + ' for database ' + @db
        ...
        BEGIN
            BEGIN TRY
                ...
                ELSE
                BEGIN
                    -- Pobieramy istniejace zapytania
                ...
                -- 5.2 Sprawdzamy spojnosc danych
                ...
                -- 5.5 i 5.6 Tworzymy klucz tylko jak nie ma problemow
                ...
                BEGIN
                    ...
                    IF @data_inconsistency = 1
                        SET @err_msg = ISNULL(@err_msg + '; ', '') + 'Data inconsistency'
            ...
            BEGIN CATCH
                ...
                PRINT 'ERROR creating FK ' + @fk_name + ': ' + @err_msg
            END CATCH
